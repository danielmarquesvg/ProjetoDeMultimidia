...
import algoritmos.PanelAlgoritmoPassaAlta;
import processarImagem.PanelDaImagem;

public class PanelPassaAlta extends JPanel {

	PanelDaImagem panelDaImagem1 = new PanelDaImagem();
	PanelAlgoritmoPassaAlta panelDaImagem2 = new PanelAlgoritmoPassaAlta();

	public PanelPassaAlta() {
		setSize(1024, 720);
		setLayout(null);
		setVisible(true);
