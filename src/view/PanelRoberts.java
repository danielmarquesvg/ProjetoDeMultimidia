...
import algoritmos.PanelAlgoritmoRoberts;
import processarImagem.PanelDaImagem;

public class PanelRoberts extends JPanel {

	PanelDaImagem panelDaImagem1 = new PanelDaImagem();
	PanelAlgoritmoRoberts panelDaImagem2 = new PanelAlgoritmoRoberts();
	...
	public PanelRoberts(){
		...
		// Corpo do sistema
		JLabel labelFiltroRoberts = new JLabel("Filtros > Roberts");
		labelFiltroRoberts.setForeground(Color.WHITE);
		labelFiltroRoberts.setFont(new Font("Segoe UI Semilight", Font.PLAIN, 24));
		labelFiltroRoberts.setBounds(10, 24, 730, 55);
		panelSuperior.add(labelFiltroRoberts);
		...
		JButton botaoRoberts = new JButton("Processar Roberts");
		...
		botaoRoberts.setBounds(204, 410, 250, 250);
		add(botaoRoberts);
