...
public class PanelRobertsCruzado extends JPanel {
	...
	public PanelRobertsCruzado(){
		...
		// Corpo do sistema
		JLabel labelFiltroRobertsCruzado = new JLabel("Filtros > Roberts Cruzado");
		labelFiltroRobertsCruzado.setForeground(Color.WHITE);
		labelFiltroRobertsCruzado.setFont(new Font("Segoe UI Semilight", Font.PLAIN, 24));
		labelFiltroRobertsCruzado.setBounds(10, 24, 730, 55);
		panelSuperior.add(labelFiltroRobertsCruzado);
